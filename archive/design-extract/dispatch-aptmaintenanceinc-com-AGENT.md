# You are building UI in the dispatch.aptmaintenanceinc.com design system.
...
```bash
npx designlang dispatch.aptmaintenanceinc.com
```
...
Generated by designlang. Re-extract by running `npx designlang dispatch.aptmaintenanceinc.com`.
