...
| A-003 | compliance.ts and GAS calculateMealPremiums produce identical results | Compliance/Legal | HIGH — PAGA liability if divergent | Side-by-side output comparison on last 90d shifts | OPEN | — | Phase 0 close | CC → Brandon decision before Phase 1 |
