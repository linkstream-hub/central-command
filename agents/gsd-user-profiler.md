...
<reference>
@C:/PTOW/1_APT_Central_Command/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/PTOW/1_APT_Central_Command/gsd-core/references/user-profiling.md` to load:
