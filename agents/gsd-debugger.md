...
<required_reading>
@C:/PTOW/1_APT_Central_Command/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@C:/PTOW/1_APT_Central_Command/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/PTOW/1_APT_Central_Command
                  → checks C:/PTOW/1_APT_Central_Command/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/PTOW/1_APT_Central_Command/gsd-core
                  → writes to C:/PTOW/1_APT_Central_Command/gsd-core/hooks/
...
@C:/PTOW/1_APT_Central_Command/gsd-core/references/thinking-models-debug.md
...
- Read @C:/PTOW/1_APT_Central_Command/gsd-core/references/common-bug-patterns.md
