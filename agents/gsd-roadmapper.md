...
Reference full template: `C:/PTOW/1_APT_Central_Command/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/PTOW/1_APT_Central_Command/gsd-core/templates/state.md`.
