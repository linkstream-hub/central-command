...
Use template from `C:/PTOW/1_APT_Central_Command/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `C:/PTOW/1_APT_Central_Command/.claude/gsd-core/templates/UI-SPEC.md`
