...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/PTOW/1_APT_Central_Command/.claude/.gsd-surface.json`
(sibling to `C:/PTOW/1_APT_Central_Command/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/PTOW/1_APT_Central_Command/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/PTOW/1_APT_Central_Command/.claude/skills`).
...
`C:/PTOW/1_APT_Central_Command/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/PTOW/1_APT_Central_Command/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/PTOW/1_APT_Central_Command/.claude/.gsd-surface.json`
Install profile marker: `C:/PTOW/1_APT_Central_Command/.claude/.gsd-profile`
Skill dirs: `C:/PTOW/1_APT_Central_Command/.claude/skills/gsd-*/`
Engine module: `C:/PTOW/1_APT_Central_Command/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/PTOW/1_APT_Central_Command/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
