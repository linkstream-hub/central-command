...
<execution_context>
@C:/PTOW/1_APT_Central_Command/.claude/gsd-core/workflows/manager.md
...
Read and execute `C:/PTOW/1_APT_Central_Command/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
