...
See C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/templates/discovery.md
...
Use C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/templates/discovery.md.
