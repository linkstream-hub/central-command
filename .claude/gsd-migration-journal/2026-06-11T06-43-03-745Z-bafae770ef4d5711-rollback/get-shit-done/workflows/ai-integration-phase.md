...
<required_reading>
@C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/references/ai-frameworks.md
@C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/PTOW/1_APT_Central_Command/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/PTOW/1_APT_Central_Command/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/PTOW/1_APT_Central_Command/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/PTOW/1_APT_Central_Command/.claude/agents/gsd-eval-planner.md for instructions.
