...
Key references:
- @C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @C:/PTOW/1_APT_Central_Command/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/USER-PROFILE.md" "C:/PTOW/1_APT_Central_Command/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/PTOW/1_APT_Central_Command/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/PTOW/1_APT_Central_Command/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/PTOW/1_APT_Central_Command/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/PTOW/1_APT_Central_Command/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/PTOW/1_APT_Central_Command/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        C:/PTOW/1_APT_Central_Command/.claude/CLAUDE.md
```
