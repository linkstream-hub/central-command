...
```bash
INIT=$(node "C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
