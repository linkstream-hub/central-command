...
```bash
INIT=$(node "C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/templates/spec.md.
