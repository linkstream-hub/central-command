...
```markdown
Read C:/PTOW/1_APT_Central_Command/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/PTOW/1_APT_Central_Command/.claude/agents/gsd-ui-checker.md for instructions.
