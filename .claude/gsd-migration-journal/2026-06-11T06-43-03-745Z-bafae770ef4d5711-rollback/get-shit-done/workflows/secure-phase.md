...
```
Agent(
  prompt="Read C:/PTOW/1_APT_Central_Command/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/templates/SECURITY.md`
