...
INSTALL_JS_GLOBAL="C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
