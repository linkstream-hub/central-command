...
<!-- For checkpoint task examples and patterns, see @C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
