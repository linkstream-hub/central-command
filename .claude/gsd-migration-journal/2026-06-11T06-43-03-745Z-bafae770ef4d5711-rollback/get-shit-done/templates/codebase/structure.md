...
- Usage: Reference from command with `@C:/PTOW/1_APT_Central_Command/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/PTOW/1_APT_Central_Command/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/PTOW/1_APT_Central_Command/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
