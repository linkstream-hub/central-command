# You are building UI in the aptmaintenanceinc.com design system.
...
- secondary   #408bd1
- accent      #223068
- neutrals    #404040 · #000000 · #ffffff · #999999 · #ebebeb · #c5c8be

## Typography

- families   Raleway · Times New Roman
- weights    400 · 700 · 500 · 600
- base size  16px

## Spacing

- scale      2px · 18px · 30px · 36px · 40px · 43px · 50px · 54px · 63px · 67px · 72px · 80px

## Radii

- scale      2px · 10px · 40px · 100px
...
- headings   Title Case
- CTA verbs  view · property · as · load
...
```bash
npx designlang aptmaintenanceinc.com
```
...
Generated by designlang. Re-extract by running `npx designlang aptmaintenanceinc.com`.
